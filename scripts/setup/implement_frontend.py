...
dash_dir = os.path.join(base_dir, "apps/dashboard-web")
...
write_file(dash_dir, "package.json", json.dumps({
  "name": "dashboard-web",
  "version": "1.0.0",
  "private": True,
  "scripts": {
...
write_file(dash_dir, "src/app/globals.css", """@tailwind base;
@tailwind components;
@tailwind utilities;
...
write_file(dash_dir, "src/app/layout.tsx", """import './globals.css'
...
write_file(dash_dir, "src/app/page.tsx", """import DashboardShell from '../layouts/DashboardShell'
...
write_file(dash_dir, "src/layouts/DashboardShell.tsx", """'use client'
...
print("Dashboard UI (React/Next.js) constructed.")
