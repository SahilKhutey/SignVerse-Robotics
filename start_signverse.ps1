...
Start-Process powershell -ArgumentList "-NoExit -Command `"cd '$pwdPath'; `$env:PYTHONPATH = '$pwdPath'; `$env:OS_API_KEY = 'signverse_local_dev_key'; uvicorn backend.api.main:app --host 0.0.0.0 --port 8000 --reload`""
