...
Write-Host "2. Starting React Control Center Dashboard..." -ForegroundColor Green
Start-Process powershell -ArgumentList "-NoExit -Command `"cd '$pwdPath'; pnpm --filter dashboard-web run dev`""
